...
import { FiSettings, FiGlobe, FiCreditCard, FiTruck, FiClock, FiDollarSign, FiArrowLeft, FiSave, FiRefreshCw, FiAlertTriangle } from 'react-icons/fi'
...
const EditStoreConfigurations = () => {
  ...
  // API hooks
  const { data: configData, isLoading: configLoading, isError: configError, error } = useGetStoreConfig()
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/settings/store-configurations')
    } catch (error) {
    ...
    <div className="p-4 md:p-6 max-w-6xl mx-auto overflow-x-hidden">
      ...
      {configError && !configLoading && (
        <div className="min-h-[60vh] flex items-center justify-center">
          <div className="text-center">
            ...
            <Link to="/settings/store-configurations" className="btn-primary inline-block">
      ...
      <div className="mb-6 md:mb-8">
        <div className="flex items-center gap-4 mb-4">
          <Link
            to="/settings/store-configurations"
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-2xl md:text-3xl font-bold text-gray-900 mb-2">
                {hasConfig ? 'Edit Store Configuration' : 'Create Store Configuration'}
              </h1>
          ...
          {hasConfig && (
            <div className="flex gap-2 w-full md:w-auto">
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-2 px-4 py-2 text-gray-600 border border-gray-300 rounded-lg hover:bg-gray-50 disabled:opacity-50 w-full md:w-auto justify-center"
              >
...
export default EditStoreConfigurations
