...
import { FiArrowLeft, FiPrinter, FiMoreVertical, FiUser, FiCreditCard, FiDownload, FiCheckCircle, FiBox, FiTruck, FiCalendar, FiMapPin, FiAlertTriangle, FiPackage } from 'react-icons/fi'
...
const OrderDetail = () => {
  ...
  const { data: order, isLoading, isError, error, refetch } = useGetOrderById(id)
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      {isLoading && (
        <div className="p-4">
          <div className="bg-white border-b border-primary/10 px-6 py-4 mb-4">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div className="lg:col-span-2 space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                <div className="h-8 w-48 animate-pulse rounded bg-gray-300 mb-4" />
                <div className="space-y-4">
                  {[...Array(3)].map((_, i) => (
                    <div key={i} className="flex gap-4">
                      <div className="h-16 w-16 animate-pulse rounded-lg bg-gray-300" />
            ...
            <div className="space-y-6">
              <div className="bg-white border border-gray-200 rounded-lg p-6">
                ...
                <div className="space-y-3">
                  {[...Array(5)].map((_, i) => (
                    <div key={i} className="h-4 w-full animate-pulse rounded bg-gray-300" />
                  ))}
                </div>
              </div>
            </div>
